...
urlpatterns = [
    ...
    path(
        r"thermo-autocomplete/",
        views.ThermoAutocompleteView.as_view(),
        name="thermo-autocomplete",
    ),
    path(r"transport/<int:pk>", views.TransportDetail.as_view(), name="transport-detail"),
    path(
        r"transport-autocomplete/",
        views.TransportAutocompleteView.as_view(),
        name="transport-autocomplete",
    ),
    ...
    path(
        r"kinetics-autocomplete/",
        views.KineticsAutocompleteView.as_view(),
        name="kinetics-autocomplete",
    ),
    path(r"kineticmodel/<int:pk>", views.KineticModelDetail.as_view(), name="kinetic-model-detail"),
    path(
        r"kineticmodel/<int:pk>/revise",
        views.KineticModelRevisionView.as_view(),
        name="kinetic-model-revision",
    ),
