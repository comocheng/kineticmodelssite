# Generated by Django 3.0 on 2021-01-02 02:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='database.TransportComment')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
                ('kinetic_model', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='database.KineticModel')),
                ('target', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='database.ThermoComment')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('species', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='database.Species')),
                ('target', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='database.SpeciesName')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='database.KineticsComment')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='kineticmodel',
            name='target',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='database.KineticModel'),
        ),
        migrations.AddField(
            model_name='kineticmodel',
            name='thermo',
        ...
        migrations.CreateModel(
            ...
            bases=('database.kineticscomment', models.Model),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            bases=('database.speciesname', models.Model),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            bases=('database.thermocomment', models.Model),
        ),
        migrations.CreateModel(
            name='TransportCommentRevision',
            fields=[
            ],
            options={
                'proxy': True,
            ...
            bases=('database.transportcomment', models.Model),
        ),
        migrations.CreateModel(
            name='Troe',
            fields=[
