# Generated by Django 3.0 on 2021-01-04 18:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('latest', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='master', to='database.Species')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('species', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='database.SpeciesMaster')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('original_id', models.UUIDField(unique=True)),
                ('latest', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='master', to='database.Reaction')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='reaction',
            name='species',
            field=models.ManyToManyField(through='database.Stoichiometry', to='database.SpeciesMaster'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='kinetics',
            name='reaction',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='database.ReactionMaster'),
        ),
        migrations.AddField(
            model_name='kinetics',
            name='source',
        ...
        migrations.CreateModel(
            name='KineticModelMaster',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('original_id', models.UUIDField(unique=True)),
                ('latest', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='master', to='database.KineticModel')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='kineticmodel',
            name='species',
            field=models.ManyToManyField(through='database.SpeciesName', to='database.SpeciesMaster'),
        ),
        migrations.AddField(
            model_name='kineticmodel',
            name='thermo',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, through='database.Efficiency', to='database.SpeciesMaster'),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            bases=('database.kineticmodel', models.Model),
        ),
        migrations.CreateModel(
            name='KineticModelRevision',
            fields=[
            ],
            options={
                'proxy': True,
