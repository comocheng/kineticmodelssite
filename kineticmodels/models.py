...
"""
TODO --
# Instead of a dictionary for chemical_species vs efficiency,
# Use a ManyToMany between KineticsData instance and Species Instance,
# With the efficiency value as an attribute to the through class
"""
...
class Lindemann(BaseKineticsData):
    low_arrhenius = models.ForeignKey(Arrhenius)
