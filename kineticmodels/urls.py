...
urlpatterns=[
    ...
    url(r'^bibliography/$', views.SourceListView.as_view(), 
                                                        name='bibliography'),
    url(r'^source/(?P<source_id>[0-9]+)/$', views.SourceView.as_view(), 
                                                        name='sourceView'),
    url(r'^source/(?P<source_id>[0-9]+)/edit/$', views.SourceEditor.as_view(), 
                                                        name='sourceEditor'),
    url(r'^source/search/$', views.SourceSearchView.as_view(), 
                                                        name='sourceSearch'),
    url(r'^source/new/$', views.SourceNew.as_view(), name='sourceNew'),    



    url(r'^source/author-autocomplete/$', views.AuthorAutocomplete.as_view(), 
                                                    name='authorAutocomplete'),
    url(r'^models/source-autocomplete/$', views.SourceAutocomplete.as_view(), 
    ...
    url(r'^species/(?P<species_id>[0-9]+)/$', views.SpeciesView.as_view(), 
                                                        name='speciesView'),
    url(r'^species/(?P<species_id>[0-9]+)/edit/$', 
                        views.SpeciesEditor.as_view(), name='speciesEditor'),
    url(r'^species/search/$', views.SpeciesSearchView.as_view(), 
                                                        name='speciesSearch'),  
    


    url(r'^models/$', views.KineticModelListView.as_view(), 
                                                    name='kineticModelList'),
    url(r'^models/new/$', views.KineticModelNew.as_view(), 
    ...
    url(r'^reactions/$', views.ReactionListView.as_view(), 
                                                        name='reactionList'),
    ...
    url(r'^reactions/(?P<reaction_id>[0-9]+)/edit/$', 
                                views.ReactionEditor.as_view(), 
                                                        name='reactionEditor'),       
    url(r'^reactions/search/$', views.ReactionSearchView.as_view(), 
                                                        name='reactionSearch'),  
