...
urlpatterns=[
    ...
    url(r'^models/(?P<model_id>[0-9]+)/edit/$', views.kineticModel_editor, name='kinetic model editor'), 
    url(r'^reactions/$', views.reaction_list, name='reaction list'),
    url(r'^reactions/(?P<species_id>[0-9]+)/edit/$', views.reaction_editor, name='reaction editor'),       
